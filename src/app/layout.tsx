...
export const metadata: Metadata = {
  ...
  description: 'HABB Lanka is a Sri Lankan digital engineering partner specialising in web, mobile, cloud and AI solutions. We design and build secure, scalable products with focus on reliability and rapid time-to-market.',
}
